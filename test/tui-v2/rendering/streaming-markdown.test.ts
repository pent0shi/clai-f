...
import {
  ...
  stableMarkdownSplit,
} from "../../../src/tui-v2/rendering/streaming-markdown.js";
import { renderMarkdownLines } from "../../../src/tui-v2/rendering/render-markdown-lines.js";

const OPTIONS = { width: 72, defaultFg: "#a6e3a1", stripOuterIndent: true } as const;
